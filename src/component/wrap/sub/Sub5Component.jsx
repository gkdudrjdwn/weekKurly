...
가입일 userGaib 자동날짜 timestamp now() => current_timestam
*/
    ...
    const onSubmitSignup =(e)=>{
        ...
        formData.append('userChoochunin',state.추천인);
        formData.append('userService',state.이용약관동의);

        axios({
            url:'http://ha0jeong.dothome.co.kr/weekKurly/signup_insert_react.php',
            method:'POST',
            data: formData
        })
        .then((res)=>{
